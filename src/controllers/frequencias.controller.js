...
// Registra a frequência de uma turma inteira num único dia, de uma vez.
// Espera no body: { turma_id, data, presencas: [{ aluno_id, presente }, ...] }
...
export default {listarFrequencias, registrarFrequenciaAluno, registrarFrequenciaTurma, atualizarFrequencia, deletarFrequencia};